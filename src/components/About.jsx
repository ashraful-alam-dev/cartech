      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 text-left">
            <h2 className="text-amber-300 text-sm md:text-base uppercase tracking-[0.3em] font-bold mb-4">
              Our Legacy
            </h2>
            <h3 className="text-3xl md:text-5xl font-bold text-amber-50 mb-6 leading-tight">
            ...
            <div className="grid grid-cols-2 gap-8 border-t border-gray-800 pt-8">
              <div>
                <p className="text-3xl font-bold text-amber-50 mb-1">15k+</p>
                <p className="text-amber-300 text-xs uppercase tracking-widest font-bold">Cars Delivered</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-amber-50 mb-1">99%</p>
                <p className="text-amber-300 text-xs uppercase tracking-widest font-bold">Customer Rating</p>
              </div>
            </div>
            ...
            <div className="mt-10">
              <a
                href="#contact"
                className="inline-block px-8 py-3 rounded-xl border-2 border-amber-400 text-amber-200 font-bold hover:bg-amber-400 hover:text-gray-900 transition-all duration-300"
              >
                Meet the Team
              </a>
            </div>
